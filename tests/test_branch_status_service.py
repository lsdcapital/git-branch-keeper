...
class TestBranchStatusDetection:
    ...
    def test_get_status_protected_branch(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
    ...
    def test_get_status_with_open_pr(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
    ...
    def test_get_status_merged_via_pr(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
    ...
    def test_get_status_merged_via_git(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
    ...
    def test_get_status_stale_branch(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
    ...
    def test_get_status_active_branch(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
...
class TestBranchProtection:
    ...
    def test_is_protected_branch_true(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
    ...
    def test_is_protected_branch_false(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
...
class TestBranchIgnorePatterns:
    ...
    def test_should_ignore_branch_true(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
    ...
    def test_should_ignore_branch_false(self, mock_git_repo, mock_config, mock_git_service, mock_github_service):
