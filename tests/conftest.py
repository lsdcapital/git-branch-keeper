...
def mock_git_service(mock_config, mock_git_repo):
    ...
    # Default to "this branch has commits of its own" so tests exercising merged/stale
    # detection are not short-circuited into UNSTARTED. Tests covering unstarted
