...
def parse_args():
    ...
    parser.add_argument("--cleanup", action="store_true", help="(Deprecated: cleanup is now default) Actually delete branches")
    parser.add_argument("--force", action="store_true", help="Skip confirmations")
    parser.add_argument("--interactive", action="store_true", help="Launch interactive TUI mode (default for TTY)")
    parser.add_argument("--no-interactive", action="store_true", help="Force non-interactive CLI mode (for scripts/automation)")
